...
class FileSystem {
  /**
   * [Async] Checks if a file exists at the given path
  ...
  /**
   * [Async] Gets information about a file or directory
   * @param filePath - Path to check
  ...
  /**
   * [Async] Creates a directory if it doesn't exist
  ...
  /**
   * [Async] Writes content to a file, creating parent directories if needed
   * @param filePath - Path to the file
  ...
  /**
   * [Async] Appends content to a file, creating the file and parent directories if needed
   * @param filePath - Path to the file
  ...
  /**
   * [Async] Copies a file from source to destination
  ...
  /**
   * [Async] Moves a file from source to destination
   * @param src - Source file path
   * @param dest - Destination file path
   * @param overwrite - Whether to overwrite existing destination
  ...
  /**
   * [Async] Deletes a file if it exists
   * @param filePath - Path to the file
  ...
  /**
   * [Async] Copies a directory recursively
  ...
  /**
   * [Async] Deletes a directory and its contents
  ...
  /**
   * [Async] Lists directory contents
   * @param dirPath - Path to the directory
  ...
  /**
   * [Async] Streams a file from source to destination with proper error handling
  ...
  /**
   * [Async] Creates a temporary file with random name
  ...
  /**
   * [Async] Creates a temporary directory with random name
  ...
  /**
   * [Async] Ensures a file exists, throwing a specific error if not
  ...
  /**
   * [Async] Ensures a directory exists, throwing a specific error if not
  ...
  /**
   * [Async] Changes file permissions
   * @param filePath - Path to the file
